...
use crate::raytracer::utils::consts::RAY_PER_REFLET;
...
impl MaterialPrimitive for Metal {
    fn get_color(
        ...
        if max_iter > 0 {
            ...
            for i in 0..RAY_PER_REFLET {
                for j in 0..RAY_PER_REFLET {
            ...
            return new_color / (RAY_PER_REFLET as f32 * RAY_PER_REFLET as f32);
        }
        BLACK
    }
}
